...
private val CREATE_SPECIFIC_MESSAGES : List<String> = listOf("Create a new event", "Create event", "Error on the event creation")
private val EDIT_SPECIFIC_MESSAGES : List<String> = listOf("Edit an event", "Edit event", "Error on the event edition")
...
//        //fetchedEvent = eventViewModel.fetchEvent(eventID)
//        fetchedEvent = EventFirebaseConnection.fetchEvent(eventID)
//        title = TextFieldValue(fetchedEvent.title)
//        description = TextFieldValue(fetchedEvent.description!!)
//        location = fetchedEvent.location
//        eventStartDate = TextFieldValue(fetchedEvent.eventStartDate.toString())
//        eventEndDate = TextFieldValue(fetchedEvent.eventEndDate?.toString() ?: "")
//        eventTimeStart = TextFieldValue(fetchedEvent.timeBeginning.toString())
//        eventTimeEnd = TextFieldValue(fetchedEvent.timeEnding.toString())
//        maxAttendees = TextFieldValue(fetchedEvent.attendanceMaxCapacity?.toString() ?: "")
//        minAttendees = TextFieldValue(fetchedEvent.attendanceMinCapacity.toString())
//        inscriptionLimitDate = TextFieldValue(fetchedEvent.inscriptionLimitDate?.toString() ?: "")
//        inscriptionLimitTime = TextFieldValue(fetchedEvent.inscriptionLimitTime?.toString() ?: "")
//
//    }
    ...
    Scaffold(
        ...
        topBar = {
            MediumTopAppBar(
                title = {
                    Text(text = MESSAGES[eventAction.ordinal][TITLE_MESSAGE_INDEX],
