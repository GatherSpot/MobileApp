 ...
 * @param collection: the collection where the list will be stored
 * useful for example to store a friend list, a list of events the user is attending, etc.
 */
class IdList(override val id: String, var events: List<String>, val collection: FirebaseCollection) :
    CollectionClass() {
