...
class FirebaseImages {
    ...
    /**
     * To fetch an image from the cloud storage, you can use the following composable :
     * AsyncImage(
    ...
    /**
     * An asynchronous function that pushes the profile picture to the profile image cloud storage
     * on success returns the image url, elses empty
     */
