...
class ChatUITest {
  ...
  // Here, we use mockito to disable the listenToMessages function, this way we effectively disable
  // unwanted Firebase interactions + mock as we want

  @Test
  fun testEverythingExists() {
    val eventId = DefaultEvents.trivialEvent1.id
    val chatViewModel =
        ChatViewModel(eventId, MockEventFirebaseConnection(), MockChatMessagesFirebaseConnection())
