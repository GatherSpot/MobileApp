...
class SignUpScreen(semanticsProvider: SemanticsNodeInteractionsProvider) :
  ...
  val badUsername: KNode = onNode { hasText("Username already taken") }
  val badEmail: KNode = onNode { hasText("Invalid Email") }
  val badPassword: KNode = onNode { hasText("Invalid Password") }
}
