...
class MockIdListFirebaseConnection : IdListFirebaseConnection() {
  ...
  override suspend fun fetch(id: String, category: FirebaseCollection, onSuccess: () -> Unit): IdList {
    onSuccess()
    return IdList(id, listOf("1", "2", "3"), category)
  }

  override fun addElement(id: String, category: FirebaseCollection, element: String, onSuccess: () -> Unit) {
    onSuccess()
  }
