...
class EventFirebaseConnectionTest {
 ...
 "6"))
    ...
    lateinit var listOfEvents1: MutableList<Event>
    runBlocking {
      listOfEvents1 = eventFirebaseConnection.fetchEventsBasedOnInterests(round.toLong(),
 interests)
    }
    lateinit var listOfEvents2: MutableList<Event>
    runBlocking {
      listOfEvents2 = eventFirebaseConnection.fetchEventsBasedOnInterests(round.toLong(),
 interests)
    }
