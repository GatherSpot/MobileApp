...
exports.validateDocumentReference = exports.validateQueryOperator = exports.validateQueryOrder = exports.VectorQuery = exports.AggregateQuerySnapshot = exports.AggregateQuery = exports.CollectionReference = exports.Query = exports.QueryOptions = exports.VectorQuerySnapshot = exports.QuerySnapshot = exports.FieldOrder = exports.DocumentReference = void 0;
...
class Query {
    ...
    _queryOptions) {
        ...
        this._queryUtil = new QueryUtil(_firestore, _queryOptions, this._serializer);
    }
    /**
    ...
    findNearest(vectorField, queryVector, options) {
        ...
        return new VectorQuery(this, vectorField, queryVector, new VectorQueryOptions(options.limit, options.distanceMeasure));
    }
    /**
    ...
    _createSnapshot(readTime, size, docs, changes) {
        return new QuerySnapshot(this, readTime, size, docs, changes);
    }
}
exports.Query = Query;
/**
...
class VectorQuery {
    ...
    constructor(_query, vectorField, queryVector, options) {
        ...
        this._queryUtil = new QueryUtil(_query._firestore, _query._queryOptions, _query._serializer);
    }
     ...
     */
    async get() {
        const { result } = await this._queryUtil._getResponse(this, 
     ...
     */
    _createSnapshot(readTime, size, docs, changes) {
        return new VectorQuerySnapshot(this, readTime, size, docs, changes);
    }
    /**
