...
export declare namespace youtube_v3 {
    ...
    export class Resource$Youtube$V3$Livechat$Messages {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        transition(params: Params$Resource$Youtube$V3$Livechat$Messages$Transition, options: StreamMethodOptions): GaxiosPromise<Readable>;
        transition(params?: Params$Resource$Youtube$V3$Livechat$Messages$Transition, options?: MethodOptions): GaxiosPromise<Schema$LiveChatMessage>;
        transition(params: Params$Resource$Youtube$V3$Livechat$Messages$Transition, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        transition(params: Params$Resource$Youtube$V3$Livechat$Messages$Transition, options: MethodOptions | BodyResponseCallback<Schema$LiveChatMessage>, callback: BodyResponseCallback<Schema$LiveChatMessage>): void;
        transition(params: Params$Resource$Youtube$V3$Livechat$Messages$Transition, callback: BodyResponseCallback<Schema$LiveChatMessage>): void;
        transition(callback: BodyResponseCallback<Schema$LiveChatMessage>): void;
    }
    export interface Params$Resource$Youtube$V3$Livechat$Messages$Transition extends StandardParameters {
        /**
